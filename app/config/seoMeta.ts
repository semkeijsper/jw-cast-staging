...
export const prerenderLocales = [
  'en', 'nl', 'cmn_hans', 'da', 'de', 'es', 'fi', 'fr', 'it', 'ja', 'ko',
  'pl', 'pt', 'ru', 'tl',
];
...
/**
 * One entry per locale in `prerenderLocales` / public/sitemap.xml / config/uiStrings.ts —
 * those four lists are kept identical. Any other locale still routes at runtime and
 * falls back to `en` here.
 */
